...
@media (max-width: 700px) {
  ...
  .date-input-v2 { flex: 1; width: auto; min-width: 0; font-size: .82rem; }
  .date-sep { flex-shrink: 0; }
  ...
  /* Cabeçalho do modal */
  .det-modal-header { padding: 1rem 1rem .85rem; flex-wrap: wrap; gap: .5rem; }
  .det-venda-num { font-size: 1.2rem; }
  .det-header-meta { gap: .5rem; }
  .det-sub-item { font-size: .76rem; }
  .det-header-right { gap: .35rem; flex-wrap: wrap; justify-content: flex-end; flex-shrink: 0; }
